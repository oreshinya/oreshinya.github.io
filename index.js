...
var _user$project$Style$ClickedBorn = {ctor: 'ClickedBorn'};
var _user$project$Style$Born = {ctor: 'Born'};
var _user$project$Style$ImageLink = {ctor: 'ImageLink'};
var _user$project$Style$ClickedImageContainer = {ctor: 'ClickedImageContainer'};
var _user$project$Style$ImageContainer = {ctor: 'ImageContainer'};
var _user$project$Style$Oreshinya = {ctor: 'Oreshinya'};
var _user$project$Style$Loupe = {ctor: 'Loupe'};
var _user$project$Style$Field = {ctor: 'Field'};
var _user$project$Style$SearchArea = {ctor: 'SearchArea'};
var _user$project$Style$BottomContainer = {ctor: 'BottomContainer'};
var _user$project$Style$TopContainer = {ctor: 'TopContainer'};
var _user$project$Style$App = {ctor: 'App'};
var _user$project$Style$styles = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'oreshinya', _p0));
}(
	{
		ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						_user$project$Style$TopContainer,
						{
							ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: A2(_rtfeldman$elm_css$Css$property, 'justify-content', 'flex-start'),
													_1: {
														ctor: '::',
															...
															_1: {
																...
																_1: {
																	...
																	_0: _rtfeldman$elm_css$Css$backgroundColor(
																		_rtfeldman$elm_css$Css$hex('00BCD4')),
																	_1: {
																		ctor: '::',
																		_0: A4(
					...
					_1: {
						...
						_0: A2(
							...
							_user$project$Style$BottomContainer,
							{
								ctor: '::',
								_0: A2(_rtfeldman$elm_css$Css$property, 'height', 'calc(100% - 80px)'),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$relative),
									_1: {
						...
						_1: {
							...
							_0: A2(
								...
								_user$project$Style$SearchArea,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$height(
										_rtfeldman$elm_css$Css$pct(100)),
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												...
												_user$project$Style$ImageContainer,
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$width(
														_rtfeldman$elm_css$Css$px(60)),
											...
											_1: {
												...
												_0: A2(
													...
													_user$project$Style$ClickedImageContainer,
													{
														ctor: '::',
														_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'jump-block 0.1s linear 0.1s 1'),
														_1: {
															ctor: '::',
															_0: A2(_rtfeldman$elm_css$Css$property, 'animation-fill-mode', 'forwards'),
															_1: {
																ctor: '::',
													...
													_1: {
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: _rtfeldman$elm_css$Css$backgroundImage(
																				_rtfeldman$elm_css$Css$url('./images/hone.png')),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					_rtfeldman$elm_css$Css$backgroundSize2,
																					_rtfeldman$elm_css$Css$px(96),
																					_rtfeldman$elm_css$Css$px(128)),
																				_1: {
																					ctor: '::',
																					_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'walk 1s step-start 0s infinite'),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
														...
														_1: {
															...
															_0: A2(
																...
																_user$project$Style$ClickedBorn,
																{
																	ctor: '::',
																	_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'jump 0.1s linear 0s 1, walk 1s step-start 0s infinite'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
...
var _user$project$Main$bornClass = function (_p0) {
	var _p1 = _p0;
	return _p1.visibleInfo ? {
		ctor: '::',
		_0: _user$project$Style$Born,
		_1: {
			ctor: '::',
			_0: _user$project$Style$ClickedBorn,
			_1: {ctor: '[]'}
		}
	} : {
		ctor: '::',
...
var _user$project$Main$imageContainerClass = function (_p2) {
	var _p3 = _p2;
	return _p3.visibleInfo ? {
		ctor: '::',
		_0: _user$project$Style$ImageContainer,
		_1: {
			ctor: '::',
			_0: _user$project$Style$ClickedImageContainer,
			_1: {ctor: '[]'}
		}
	} : {
		ctor: '::',
...
var _user$project$Main$oreshinyaContainerStyles = function (_p4) {
	var _p5 = _p4;
	return {
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$marginTop(
			_rtfeldman$elm_css$Css$px(_p5.oreshinyaY)),
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$marginLeft(
				_rtfeldman$elm_css$Css$px(_p5.oreshinyaX)),
			_1: {ctor: '[]'}
		}
	};
};
var _user$project$Main$fieldStyles = function (_p6) {
	var _p7 = _p6;
	return {
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$top(
			_rtfeldman$elm_css$Css$px(-1 * _p7.loupeY)),
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$left(
				_rtfeldman$elm_css$Css$px(-1 * _p7.loupeX)),
			_1: {ctor: '[]'}
		}
	};
};
var _user$project$Main$loupeStyles = function (_p8) {
	var _p9 = _p8;
	return {
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$top(
			_rtfeldman$elm_css$Css$px(_p9.loupeY)),
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$left(
				_rtfeldman$elm_css$Css$px(_p9.loupeX)),
			_1: {ctor: '[]'}
		}
	};
};
var _user$project$Main$_p10 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('oreshinya');
var _user$project$Main$class = _user$project$Main$_p10.$class;
var _user$project$Main$linkView = function (_p11) {
	var _p12 = _p11;
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_0: _user$project$Main$class(
				{
					ctor: '::',
					_0: _user$project$Style$ImageLink,
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src(_p12._1),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
...
var _user$project$Main$styles = function (_p13) {
...
var _user$project$Main$initialModel = {
	...
	linkData: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'https://github.com/oreshinya', _1: './images/github.png'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'https://twitter.com/oreshinya', _1: './images/twitter.png'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'https://oreshinya.github.io/profile.html', _1: './images/profile.png'},
				_1: {ctor: '[]'}
			}
		}
	}
...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {windowWidth: a, windowHeight: b, loupeX: c, loupeY: d, oreshinyaX: e, oreshinyaY: f, visibleInfo: g, linkData: h};
	});
var _user$project$Main$InitOreshinyaY = function (a) {
	return {ctor: 'InitOreshinyaY', _0: a};
};
var _user$project$Main$InitOreshinyaX = function (a) {
	return {ctor: 'InitOreshinyaX', _0: a};
};
var _user$project$Main$InitLoupeY = function (a) {
	return {ctor: 'InitLoupeY', _0: a};
};
var _user$project$Main$InitLoupeX = function (a) {
	return {ctor: 'InitLoupeX', _0: a};
};
		...
		switch (_p14.ctor) {
			...
			case 'MoveLoupe':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							loupeX: _elm_lang$core$Basics$toFloat(_p14._0 - 60),
							loupeY: _elm_lang$core$Basics$toFloat((_p14._1 - 80) - 60)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'WindowSize':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							windowWidth: _elm_lang$core$Basics$toFloat(_p14._0.width),
							windowHeight: _elm_lang$core$Basics$toFloat(_p14._0.height)
						}),
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_0: A2(
								_elm_lang$core$Random$generate,
								_user$project$Main$InitLoupeX,
								A2(_elm_lang$core$Random$float, 0, 1)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$core$Random$generate,
									_user$project$Main$InitLoupeY,
									A2(_elm_lang$core$Random$float, 0, 1)),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$core$Random$generate,
										_user$project$Main$InitOreshinyaX,
										A2(_elm_lang$core$Random$float, 0, 1)),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$core$Random$generate,
											_user$project$Main$InitOreshinyaY,
											A2(_elm_lang$core$Random$float, 0, 1)),
										_1: {ctor: '[]'}
									}
								}
			...
			case 'InitLoupeX':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loupeX: _p14._0 * (model.windowWidth - 120)}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InitLoupeY':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loupeY: _p14._0 * (model.windowHeight - 200)}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InitOreshinyaX':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{oreshinyaX: _p14._0 * (model.windowWidth - 60)}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{oreshinyaY: _p14._0 * (model.windowHeight - 140)}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$Main$MoveLoupe = F2(
	function (a, b) {
		return {ctor: 'MoveLoupe', _0: a, _1: b};
	});
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$mouse$Mouse$moves(
		function (_p15) {
			var _p16 = _p15;
			return A2(_user$project$Main$MoveLoupe, _p16.x, _p16.y);
		});
};
var _user$project$Main$ShowInfo = {ctor: 'ShowInfo'};
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _user$project$Main$class(
						{
							ctor: '::',
							_0: _user$project$Style$TopContainer,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Where\'s oreshinya ?'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _user$project$Main$class(
							{
								ctor: '::',
								_0: _user$project$Style$BottomContainer,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _user$project$Main$class(
									{
										ctor: '::',
										_0: _user$project$Style$SearchArea,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
								...
								_0: A2(
									_elm_lang$html$Html$div,
									{
										...
										_0: _user$project$Main$class(
											{
												ctor: '::',
												_0: _user$project$Style$Loupe,
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: _user$project$Main$styles(
												_user$project$Main$loupeStyles(model)),
											_1: {ctor: '[]'}
										}
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{
												...
												_0: _user$project$Main$class(
													{
														ctor: '::',
														_0: _user$project$Style$Field,
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: _user$project$Main$styles(
														_user$project$Main$fieldStyles(model)),
													_1: {ctor: '[]'}
												}
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$div,
													{
														ctor: '::',
														_0: _user$project$Main$styles(
															_user$project$Main$oreshinyaContainerStyles(model)),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$div,
															{
																...
																_0: _user$project$Main$class(
																	{
																		ctor: '::',
																		_0: _user$project$Style$Oreshinya,
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															},
															{
																...
																_0: A2(
																	_elm_lang$html$Html$div,
																	{
																		ctor: '::',
																		_0: _user$project$Main$class(
																			_user$project$Main$imageContainerClass(model)),
																		_1: {ctor: '[]'}
																	},
																	A2(_elm_lang$core$List$map, _user$project$Main$linkView, model.linkData)),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$div,
																		{
																			ctor: '::',
																			_0: _user$project$Main$class(
																				_user$project$Main$bornClass(model)),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ShowInfo),
																				_1: {ctor: '[]'}
																			}
																		},
																		{ctor: '[]'}),
